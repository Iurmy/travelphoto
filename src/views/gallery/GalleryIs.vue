  ...
  <div class="galleryIs">
    ...
    <div class="bottom-info fl fl-col">
      ...
      <div class="botton-btns">
        <div v-if="isEject == 0" class="botton-btns fl fl-jc-ctr fl-ai-ctr">
          <div @click="immediatelyBuy(1)" class="immediately bottom-btn">下载</div>
        </div>
        <div v-if="isEject == 1" class="botton-btns fl fl-jc-ctr fl-ai-ctr">
          <div @click="immediatelyBuy(1)" class="bottom-btn1">确定</div>
        </div>
      </div>
    </div>
